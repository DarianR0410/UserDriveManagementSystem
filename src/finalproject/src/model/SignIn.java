...
import org.safepassenger.dao.SignInDao;

import java.util.Scanner;

/**
 * SignIn class handles the sign-in process for users.
 * It collects user credentials, validates them, and redirects to the appropriate page.
 */
