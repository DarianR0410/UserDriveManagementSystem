...
/*
 * QrHistoryManager class is responsible for managing QR code history and interactions with the database.
 * It provides methods to insert QR codes and retrieve their history.
 */
